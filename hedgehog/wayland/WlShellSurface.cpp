...
const struct wl_shell_surface_interface WlShellSurface::Impl::wlShellSurfaceInterface = {
	...
	+[](wl_client* client, wl_resource* resource) { debug("shell surface interface set toplevel callback called"); },
	...
	+[](wl_client* client, wl_resource* resource, wl_resource* seat, uint32_t serial, wl_resource* parent, int32_t x,
		int32_t y,
		uint32_t flags) { warning("shell surface interface set popup callback called (not yet implemented)"); },
